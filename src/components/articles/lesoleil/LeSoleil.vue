    ...
    <section class="content">
        ...
        <div class="sections-container">
            <section class="section">
                <img class="header-image" src="/images/the-sun-sun.png" alt="Le Soleil" />
                <h1 class="article-title">{{ title }}</h1>
                <p class="article-date">{{ formatDate(date) }}</p>
                <p class="article-note">{{ note }}</p>
...
import content from './le-soleil.md'
...
export default {
    data() {
        return {
            title: "Le Soleil",
            subtitle: "Une nouvelle sur une baleine et le soleil",
            note: "I translated my short story 'The Sun' into French, using Claude for feedback. If you spot any errors please let me know!",
