<template>
    <section class="content" :style="{'background-image': 'url(/images/evo_particle_life.png)'}">
...
import content from './evo-particle-life.md'
...
export default {
    data() {
        return {
            ...
            subtitle: "Evolving interaction rules in particle life simulations",
            date: new Date('2026-02-21'),
            image_path: '/images/evo_particle_life.png',
            slug: 'ImplicitEvoParticleLife'
        }
    },
    computed: {
        renderedContent() {
